    ...
    <div className="mx-auto max-w-screen-2xl px-3 sm:px-6 py-5 sm:py-8">
      ...
      <div className="grid gap-4 sm:gap-6 lg:grid-cols-3">
        ...
        <div className="space-y-4">
          ...
          {/* Contact admin */}
          <div className="animate-fade-up delay-500 rounded-2xl border border-gray-100 bg-white p-5 shadow-sm">
            <div className="mb-3 flex items-center gap-3">
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-[#2AABEE]">
              ...
              <div>
                <p className="font-bold text-black text-sm">Contact Admin</p>
            ...
            <a href="https://t.me/nvrmuhammad" target="_blank" rel="noopener noreferrer"
              className="flex items-center justify-center gap-2 w-full rounded-full bg-[#2AABEE] py-2.5 text-sm font-bold text-white hover:bg-[#229ED9] transition">
              Message on Telegram
            </a>
          </div>
        </div>
